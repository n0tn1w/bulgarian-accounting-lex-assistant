...
SYSTEM_PROMPT = (
    ...
    "- MANDATORY for legal questions: if the question is about ДДС/VAT treatment (ДДС третиране), "
    "a tax rate, a deadline, обратно начисляване, or whether something complies with ЗДДС/ЗКПО, you "
    "MUST call query_law BEFORE you answer, and cite the exact article it returns (e.g. 'ЗДДС чл. "
    "66'). NEVER answer a legal question from your own knowledge: without a query_law result you "
    "have no legal basis and must not state what the law says or whether something is correct.\n"
